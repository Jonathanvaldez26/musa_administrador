     ...
     foreach ($vuelos as $key => $value) {
            ...
            <tr>
                ...
                <td style="text-align:center; vertical-align:middle;">
                    ...
                    <button class="btn bg-gradient-danger btn-icon-only" id="btn-borrar-{$value['id_pase_abordar']}" onclick="borrarPaseAbordar({$value['id_pase_abordar']})" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Eliminar Pase de Abordar de {$value['nombre']}"><span class="fas fa-trash"></span></button>
                </td>
